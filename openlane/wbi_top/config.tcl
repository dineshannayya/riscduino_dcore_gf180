...
set ::env(VERILOG_FILES) "\
     ...
     $::env(DESIGN_DIR)/../../verilog/rtl/wb_interconnect/src/wbi_top.sv     \
     $::env(DESIGN_DIR)/../../verilog/rtl/wb_interconnect/src/wbi_master_port.sv     \
     $::env(DESIGN_DIR)/../../verilog/rtl/wb_interconnect/src/wbi_arb2.sv  \
     $::env(DESIGN_DIR)/../../verilog/rtl/wb_interconnect/src/wbi_master_node.sv  \
     $::env(DESIGN_DIR)/../../verilog/rtl/wb_interconnect/src/wbi_slave_port.sv   \
