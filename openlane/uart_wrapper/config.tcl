...
# Name
set ::env(DESIGN_NAME) uart_wrapper
...
set ::env(CLOCK_PORT) "app_clk u_uart0_core.u_lineclk_buf.genblk1.u_mux/X u_uart1_core.u_lineclk_buf.genblk1.u_mux/X u_uart2_core.u_core.u_lineclk_buf.genblk1.u_mux/X"
...
set ::env(VERILOG_FILES) "\
    ...
    $::env(DESIGN_DIR)/../../verilog/rtl/uartms/src/uartms_auto_det.sv \
    $::env(DESIGN_DIR)/../../verilog/rtl/uartms/src/uartms_core.sv \
    $::env(DESIGN_DIR)/../../verilog/rtl/uartms/src/uartms_cfg.sv \
    $::env(DESIGN_DIR)/../../verilog/rtl/uartms/src/uartms_top.sv \
    $::env(DESIGN_DIR)/../../verilog/rtl/uartms/src/uartms_msg_handler.v \
    ...
    $::env(DESIGN_DIR)/../../verilog/rtl/uart_wrapper/src/uart_wrapper.sv     \
    "
